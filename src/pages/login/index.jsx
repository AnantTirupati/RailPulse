  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="relative min-h-screen flex">
        ...
        <div className="flex-1  flex flex-col items-center px-6 py-12 lg:px-8 min-h-screen">
      ...
      {/* Footer */}
      <div className="bottom-0 left-0 right-0 bg-card/80 backdrop-blur-glass border-t border-border p-4">
